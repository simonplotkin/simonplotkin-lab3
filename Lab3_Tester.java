...
public class Lab3_Tester {
  ...
  @Test
  public void test1() {  // DEFINE WUAT A WORD IS. ALPHANUMERO CHARACTERS AND THE SEPARATORS (non-word characters).
    // Make an expression for what a word is: ([a-zA-Z0-9']+)\s                 (may or may not need parenthesis)
  ...
  public void test4() {
    ...
    try {
      WordCounter.processText(input, "red");
    } catch (TooSmallText e){ // Check for the length first
      result = e.toString();
    } catch (Exception e) {}
    assertEquals(expected, result);
  }
  ...
  @Test
  public void test8() { // When this unit test runs, imma open the file or creates a new final
